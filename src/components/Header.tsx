      ...
      <div className="container h-full">
        <div className="h-full flex items-center justify-between">
          <div className="h-full flex items-center">
            ...
            <span className="md:w-96 ml-8 h-10 bg-gray-100 transition rounded-lg inline-flex items-center px-3 text-gray-400 focus-within:bg-gray-200 focus-within:text-gray-900">
